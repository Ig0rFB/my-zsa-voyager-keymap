...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    ALL_T(KC_TAB),  MT(MOD_LALT, KC_A),MT(MOD_LCTL, KC_S),KC_D,           LT(1, KC_F),    KC_G,                                           KC_H,           KC_J,           KC_K,           MT(MOD_RCTL, KC_L),MT(MOD_RSFT, KC_SCLN),KC_BSPC,        
    KC_NUBS,        KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         MT(MOD_RALT, KC_SLASH),KC_BSLS,        
                                                    KC_LEFT_SHIFT,  KC_LEFT_GUI,                                    KC_ENTER,       LT(2, KC_SPACE)
  ),
  [1] = LAYOUT_voyager(
    KC_ESCAPE,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,                                          KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,         
    KC_GRAVE,       KC_EXLM,        KC_AT,          LALT(KC_3),     KC_DLR,         KC_PERC,                                        KC_7,           KC_8,           KC_9,           KC_LCBR,        KC_RCBR,        KC_F12,         
    KC_TRANSPARENT, KC_CIRC,        KC_AMPR,        KC_ASTR,        KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_4,           KC_5,           KC_6,           KC_LBRC,        KC_RBRC,        KC_BSPC,        
    KC_TRANSPARENT, KC_TRANSPARENT, KC_PLUS,        KC_ASTR,        KC_MINUS,       KC_SLASH,                                       KC_1,           KC_2,           KC_3,           KC_DOT,         KC_EQUAL,       KC_ENTER,       
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_0
  ),
  [2] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_BRIGHTNESS_DOWN,KC_BRIGHTNESS_UP,KC_AUDIO_MUTE,  KC_AUDIO_VOL_DOWN,KC_AUDIO_VOL_UP,KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_INSERT,      KC_HOME,        KC_UP,          KC_END,         KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_TAB,         KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,                                           KC_Y,           KC_U,           KC_I,           KC_O,           KC_NO,          KC_NO,          
    KC_LEFT_SHIFT,  KC_A,           KC_S,           KC_D,           KC_F,           KC_G,                                           KC_H,           KC_J,           KC_K,           KC_L,           KC_NO,          KC_NO,          
    KC_LEFT_CTRL,   KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_NO,          KC_NO,          
                                                    KC_SPACE,       KC_LEFT_GUI,                                    KC_ENTER,       KC_SPACE
  ),
};
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [3] = { {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {172,255,255}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {172,255,255}, {172,255,255}, {172,255,255}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {172,255,255}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224}, {14,196,224} },
