...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    LT(1, KC_EQUAL),KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,                                           KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_QUOTE,       
    ALL_T(KC_TAB),  MT(MOD_LSFT, KC_A),MT(MOD_LCTL, KC_S),KC_D,           KC_F,           KC_G,                                           KC_H,           KC_J,           KC_K,           MT(MOD_RCTL, KC_L),MT(MOD_RSFT, KC_SCLN),KC_BSPC,        
    KC_NUBS,        MT(MOD_LALT, KC_Z),KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         MT(MOD_RALT, KC_SLASH),KC_BSLS,        
                                                    LT(2, KC_SPACE),KC_LEFT_GUI,                                    KC_ENTER,       KC_RIGHT_SHIFT
  ),
  [1] = LAYOUT_voyager(
    KC_ESCAPE,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,                                          KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,         
    KC_TRANSPARENT, KC_EXLM,        KC_AT,          LALT(KC_3),     KC_DLR,         KC_PERC,                                        KC_7,           KC_8,           KC_9,           KC_LCBR,        KC_RCBR,        KC_F12,         
    KC_TRANSPARENT, KC_CIRC,        KC_AMPR,        KC_ASTR,        KC_LPRN,        KC_RPRN,                                        KC_4,           KC_5,           KC_6,           KC_LBRC,        KC_RBRC,        KC_BSPC,        
